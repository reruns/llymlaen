...
(function(exports) {
  ...
  var reconcile = function (c) {
      return function (r) {
          var p = 1.0 / Data_Int.toNumber(r.time - c.time);
          var f = function (a) {
              return function (b) {
                  return Data_Int.round(Data_Int.toNumber(a) + p * Data_Int.toNumber(b - a));
              };
          };
          return {
              enabled: c.enabled, 
              ...
              size: {
                  w: f(c.size.w)(r.size.w), 
                  h: f(c.size.h)(r.size.h)
              }, 
              pos: {
                  x: f(c.pos.x)(r.pos.x), 
                  y: f(c.pos.y)(r.pos.y)
              ...
              color: {
                  r: f(c.color.r)(r.color.r), 
                  g: f(c.color.g)(r.color.g), 
                  b: f(c.color.g)(r.color.b)
              }
          };
      };
  };
  ...
  var render = function (dictMonad) {
      return function (v) {
          ...
          if (v.shape instanceof Circle) {
              return at(dictMonad)(v.current.pos.x)(v.current.pos.y)(Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Graphics_Canvas_Free.functorGraphicsF)(dictMonad))(Graphics_Canvas_Free.beginPath(dictMonad))(function () {
                  return Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Graphics_Canvas_Free.functorGraphicsF)(dictMonad))(Graphics_Canvas_Free.setAlpha(dictMonad)(Data_Int.toNumber(v.current.opacity) / 100.0))(function () {
                      return Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Graphics_Canvas_Free.functorGraphicsF)(dictMonad))(Graphics_Canvas_Free.arc(dictMonad)({
                          x: 0.0, 
                          y: 0.0, 
                          r: Data_Int.toNumber(v.current.size.w), 
                          start: 0.0, 
                          end: 2.0 * $$Math.pi
                      }))(function () {
                          return Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Graphics_Canvas_Free.functorGraphicsF)(dictMonad))(Graphics_Canvas_Free.closePath(dictMonad))(function () {
                              return Graphics_Canvas_Free.stroke(dictMonad);
                          });
                      });
                  });
              }));
          };
          if (v.shape instanceof Rectangle) {
              return at(dictMonad)(v.current.pos.x)(v.current.pos.y)(Graphics_Canvas_Free.strokeRect(dictMonad)({
                  x: 0.0, 
                  y: 0.0, 
                  w: Data_Int.toNumber(v.current.size.w), 
                  h: Data_Int.toNumber(v.current.size.h)
              }));
          };
          throw new Error("Failed pattern match at Element line 60, column 1 - line 60, column 47: " + [ v.constructor.name ]);
      };
  };
  var advanceFrame = function (el) {
      var t = el.current.time + 1 | 0;
      var r = Data_Array.index(el.keys)(el.pindex + 1 | 0);
      var r$prime = Data_Maybe.fromMaybe(el.current)(r);
      var $10 = Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(Data_Functor.functorFn)(Data_Ord.greaterThanOrEq(Data_Ord.ordInt)(t))(time))(r);
      if ($10 instanceof Data_Maybe.Nothing) {
          var $14 = {};
          for (var $15 in el) {
              if ({}.hasOwnProperty.call(el, $15)) {
                  $14[$15] = el[$15];
              };
          };
          $14.current = (function () {
              var $11 = {};
              for (var $12 in el.current) {
                  if ({}.hasOwnProperty.call(el.current, $12)) {
                      $11[$12] = el.current[$12];
                  };
              };
              $11.time = t;
      ...
      if ($10 instanceof Data_Maybe.Just && !$10.value0) {
          var $17 = {};
          for (var $18 in el) {
          ...
          $17.current = reconcile(el.current)(r$prime);
          return $17;
      };
      if ($10 instanceof Data_Maybe.Just && $10.value0) {
          var $21 = {};
          for (var $22 in el) {
              if ({}.hasOwnProperty.call(el, $22)) {
                  $21[$22] = el[$22];
              };
          };
          $21.pindex = el.pindex + 1 | 0;
          $21.current = r$prime;
          return $21;
      };
      throw new Error("Failed pattern match at Element line 39, column 3 - line 42, column 57: " + [ $10.constructor.name ]);
  };
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      if (v instanceof Data_Maybe.Just) {
          ...
          var v2 = Control_Monad_ST.newSTRef(testInit)();
          Control_Monad_Eff_Timer.setInterval(16)(function __do() {
              Control_Monad_ST.modifySTRef(v2)(function (el) {
                  return Element.advanceFrame(el);
              })();
              var v3 = Control_Monad_ST.readSTRef(v2)();
              return Graphics_Canvas_Free.runGraphics(v1)(Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Graphics_Canvas_Free.functorGraphicsF)(Data_Identity.monadIdentity))(Graphics_Canvas_Free.clearRect(Data_Identity.monadIdentity)({
                  x: 0.0, 
                  y: 0.0, 
                  w: 1000.0, 
                  h: 1000.0
              }))(function () {
                  return Element.render(Data_Identity.monadIdentity)(v3);
              }))();
          })();
          return Control_Monad_Eff_Console.log("ok")();
      };
      throw new Error("Failed pattern match at Main line 17, column 3 - line 33, column 1: " + [ v.constructor.name ]);
  };
  exports["main"] = main;
